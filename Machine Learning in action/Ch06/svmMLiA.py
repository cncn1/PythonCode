...
def testRbf(k1=1.3):
    ...
    b, alphas, K = smoP(dataArr, labelArr, 200, 0.0001, 10000, ('rbf', k1))  # C=200 important
    datMat = mat(dataArr)
    ...
    for i in range(m):
        tp = tk[:, i].T * multiply(labelSV, alphas[svInd]) + b
        # print tp,'\n'
    # time.sleep(50)
...
if __name__ == '__main__':
    ...
    # b, alphs = smoP(dataMat, labelMat, 0.6, 0.001, 40)
