...
if __name__ == "__main__":
    ...
    clf = svm.SVC(C=12, kernel='rbf', gamma=20, decision_function_shape='ovr')
    ...
    svms = SVMC(x_train, y_train,C=12, kernel=Gauss_kernel)
    svms.train()
    svms.error(x_test, y_test)
